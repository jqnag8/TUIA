...
print("--- Lista de consumidoras mayores de 44 años ---")
#for id_consumidora, datos_consumidora in total.items():
    #print(datos_consumidora)
...
encuensta_1 = Encuesta("coffee_survey.csv")
